...
public class NoteBookWindow extends Application {
	...
	private HBox addHBox() {
		...
		hbox.getChildren().addAll(buttonLoad, buttonSave, labelSearch, textField, buttonSearch, buttonClear);
	...
	private VBox addVBox() {
		...
		titleslistView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Object>() {
			...
			public void changed(ObservableValue ov, Object t, Object t1) {
				...
				// textAreNote
				//#3
				Folder thisFolder = noteBook.getFolderByTitle(currentFolder);
				Note thisNote = thisFolder.getNoteByTitle(title);
				String content = thisNote.getContent();
	...
	private void updateListView() {
		...
		Folder thisFolder = noteBook.getFolderByTitle(currentFolder);
		if(thisFolder != null){
			currentnotes = thisFolder.getNotes();
		}
	...
	//#6
	private void updateListView(String keywords) {
		ArrayList<String> list = new ArrayList<String>();
		List<Note> searchresults = null;
		ArrayList<Note> currentnotes = new ArrayList<Note>();
		Folder thisFolder = noteBook.getFolderByTitle(currentFolder);
		if(thisFolder != null){
			searchresults = thisFolder.searchNotes(keywords);
		}
