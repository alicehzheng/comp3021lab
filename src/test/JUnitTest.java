...
public class JUnitTest {
	...
	@Test
	public void unknowFunction(){
		TextNote newnote1 = new TextNote("1233","456");
		Character r1 = newnote1.countLetters();
		Character expected1 = ' ';
		assertEquals("Cannot deal with situations when there's no letters",expected1,r1);
		TextNote newnote2 = new TextNote("aa","bbcc");
		Character r2 = newnote2.countLetters();
		Character expected2 = 'b';
		assertEquals("Cannot deal with letters of equal frequency",expected2,r2);
